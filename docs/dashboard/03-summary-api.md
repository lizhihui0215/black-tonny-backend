...
> 本文件只定义接口契约。
> 指标业务口径与交互规则以前端 `docs/dashboard/01-overview.md`、`02-summary-metrics.md`、`04-interaction-rules.md`、`06-summary-analysis-logic.md` 为准。
...
### 9.1 `summary.salesAmount`

销售额卡片数据

### 9.2 `summary.orderCount`

订单数卡片数据

### 9.3 `summary.avgOrderValue`

客单价卡片数据

### 9.4 `summary.salesQuantity`

销售件数卡片数据

### 9.5 `summary.attachRate`

连带率卡片数据

### 9.6 `summary.lowStockSkuCount`

低库存 SKU 数卡片数据

### 9.7 `summary.sizeBreakStyleCount`

缺码款数卡片数据

### 9.8 `summary.outOfSeasonStockQty`
