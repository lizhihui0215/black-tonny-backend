    ...
    *,
    ...
    document_entry = {
        ...
        "blocking_issues": [
            ...
            "对账指标 sales_list_order_count 仍是差异待解释",
        ],
        "next_action": "继续收口 line_count 与 sales_list_order_count，再评估销售主链准入",
    ...
    retail_entry = {
        ...
        "next_action": "继续解释 edate 的 mixed 语义，并保持研究/对账源定位",
        "current_judgment": "研究/对账源",
