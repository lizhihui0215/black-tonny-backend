...
def build_inventory_http_evidence_chain(
    *,
    ...
    return {
        ...
        "conclusion": {
            "inventory_detail_mainline_ready": not {"inventory_stockflag_semantics_pending", "inventory_pagination_semantics_pending"} & set(issue_flags),
            "outin_mainline_ready": not {"outin_datetype_semantics_pending", "outin_type_semantics_pending", "outin_doctype_semantics_pending"} & set(issue_flags),
            "next_focus": (
